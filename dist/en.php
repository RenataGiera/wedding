                ...
                <form action="<?php echo $_SERVER['REQUEST_URI']; ?>#confirm" role="form" method="post">               
                     <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="plusOne" placeholder="Name and surname of accompanying person and children">
                            </div>
                            <div class="form-group">
                                    <label for="femail"> email:</label>
                                    <input type="text" class="form-control" name="femail" placeholder="Enter your email">
                            </div>
